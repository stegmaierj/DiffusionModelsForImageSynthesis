...
class DiffusionModel3D(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser): 
        ...
        parser.add_argument('--data_root', default='/netshares/BiomedicalImageAnalysis/Projects/EschweilerLfB_CellSynthesis', type=str) 
        parser.add_argument('--train_list', default='/work/scratch/eschweiler/filelists/PNAS_syn_plant_split1_train.csv', type=str)
        parser.add_argument('--test_list', default='/work/scratch/eschweiler/filelists/PNAS_syn_plant_split1_train.csv', type=str)
        parser.add_argument('--val_list', default='/work/scratch/eschweiler/filelists/PNAS_syn_plant_split1_train.csv', type=str)
        parser.add_argument('--image_groups', default=('data/image',), type=str, nargs='+')
        parser.add_argument('--mask_groups', default=('data/boundary_decayed',), type=str, nargs='+')
