...
from ThirdParty.diffusion import SinusoidalPositionEmbeddings
...
class module_UNet3D_pixelshuffle_inject(nn.Module):
    ...
    def forward(self, img, t):
        ...
        t1 = self.t1(t)
        c1 = self.c1(img)+t1[...,None,None,None]
        d1 = self.d1(c1)
        
        t2 = self.t2(t)
        c2 = self.c2(d1)+t2[...,None,None,None]
        d2 = self.d2(c2)
        
        t3 = self.t3(t)
        c3 = self.c3(d2)+t3[...,None,None,None]
        d3 = self.d3(c3)
        
        t4 = self.t4(t)
        c4 = self.c4(d3)+t4[...,None,None,None]
        
        u1 = self.u1(c4)
        t5 = self.t5(t)
        c5 = self.c5(torch.cat((u1,c3),1))+t5[...,None,None,None]
        
        u2 = self.u2(c5)
        t6 = self.t6(t)
        c6 = self.c6(torch.cat((u2,c2),1))+t6[...,None,None,None]
        
        u3 = self.u3(c6)
        t7 = self.t7(t)
        c7 = self.c7(torch.cat((u3,c1),1))+t7[...,None,None,None]
